...
const PlaceSlug = () => {
	...
	// useSWR(`${process.env.REACT_APP_URL}/get-dest`, (...args) => {
	// 	fetch(...args, {
	// 		method: 'POST',
			...
			<div>
				...
				<div className="meta-dest">
					<p className="text-justify">
						...
						Est modi, nostrum voluptate vitae esse dignissimos,
						consectetur at laboriosam suscipit iusto aperiam eaque
						odio asperiores minima perspiciatis atque ratione facere
						ullam nam! Fuga minus in beatae libero. Voluptatibus
						impedit modi explicabo earum ducimus, odit cupiditate
						ipsum quaerat. Corporis, excepturi? Nam, quos?
					</p>
